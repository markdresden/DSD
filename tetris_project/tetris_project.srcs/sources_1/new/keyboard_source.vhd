...
begin
 ...
 -- ROTATE LEFT(Z)
 if (key_code_1 = X"F0") and (key_code_0 = X"1A") then
 key_z <= '0';
 elsif key_code_0 = X"1A" then
 key_z <= '1';
 end if;
 
  -- HOLD(C)
 if (key_code_1 = X"F0") and (key_code_0 = X"21") then
 key_c <= '0';
 elsif key_code_0 = X"21" then
 key_c <= '1';
 end if;
 
  -- RESET(ESC)
 if (key_code_1 = X"F0") and (key_code_0 = X"76") then
 key_esc <= '0';
 elsif key_code_0 = X"76" then
 key_esc <= '1';
 end if;
