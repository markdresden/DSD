...
architecture BEHV of KEYBOARD_CONTROLLER is
 ...
 type STATE_TYPE is (start, wait_clock_low, wait_clock_high,
get_key_code);
...
begin
 ...
 -- key_event is set to high for one clock cycle indicating that the
--data is available
...
when wait_clock_low =>
 ...
 ps2_word_reg <= ps2_data_f & ps2_word_reg(10
downto 1);
 end if;
 else
 state <= get_key_code;
